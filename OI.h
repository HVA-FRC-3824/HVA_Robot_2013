...
private:
	...
	JoystickButton* joystickHang;
	JoystickButton* joystickSingleShoot;
	JoystickButton* joystickRapidShoot;
	JoystickButton* shootwhenHangingonTower;
	JoystickButton* setupforMatch;
	JoystickButton* joystickShoot;
