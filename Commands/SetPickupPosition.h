...
#define FRISBEE_OFFSET                              10.0

#define PICKUP_HOME_POSITION	                  (  0.0 + FRISBEE_OFFSET) 
#define PICKUP_RELEASE_POSITION					  (175.0 + FRISBEE_OFFSET)
#define PICKUP_POSITION						      (835.0 + FRISBEE_OFFSET)
