...
#include "SetShooterAngleJoystick.h"

#define SHOOTER_ANGLE_THRESHOLD      0.1
#define SHOOTER_ANGLE_HOME         575.0

SetShooterAngleJoystick::SetShooterAngleJoystick() {
...
void SetShooterAngleJoystick::Initialize() {
...
void SetShooterAngleJoystick::Execute() {
	   float angle;
...
bool SetShooterAngleJoystick::IsFinished() {
	return false;
}

// Called once after isFinished returns true
void SetShooterAngleJoystick::End() {
	
}

// Called when another command which requires one or more of the same
// subsystems is scheduled to run
void SetShooterAngleJoystick::Interrupted() {
