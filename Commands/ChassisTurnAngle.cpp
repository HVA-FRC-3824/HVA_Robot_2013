...
ChassisTurnAngle::ChassisTurnAngle(double turnAngle) : degreesToTurn(turnAngle), PIDcontroller(0.0, 0.0, 0.0, Robot::drivetrain, Robot::drivetrain), anglePassed(true)
{
	// BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=REQUIRES
	Requires(Robot::drivetrain);
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=REQUIRES
...
//		      SmartDashboard::GetNumber("Chassis Turn D Term"));
   ...
   PIDcontroller.SetPID(TURN_P_TERM, TURN_I_TERM, TURN_D_TERM);
