...
SetPickupSuction::SetPickupSuction() 
{
	...
	sucktionSetInConstructor = false;
	SmartDashboard::PutBoolean("Pickup Suction", Robot::pickup->suction->Get());
}
SetPickupSuction::SetPickupSuction(bool sucktion_parameter)
{
	sucktion = sucktion_parameter;
	sucktionSetInConstructor = true;
}
// Called just before this Command runs the first time
void SetPickupSuction::Initialize() 
{
	// Check if the suction is already set
	if(sucktionSetInConstructor == false)
	{
		sucktion = 	SmartDashboard::GetBoolean("Pickup Suction");
	}
	
	Robot::pickup->suction->Set(sucktion);
}
