...
{
	printf("HangerPullDown Initialize\n");
}
...
{
   printf("HangerPullDown End\n");
}
// Called when another command which requires one or more of the same
// subsystems is scheduled to run
void HangerPullDown::Interrupted() 
{
   printf("HangerPullDown Interrupted\n");
   End();
}
