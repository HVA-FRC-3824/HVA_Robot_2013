...
ChassisDrivetoWall::ChassisDrivetoWall() 
{
	...
	PIDcontroller = new PIDController(
		      SmartDashboard::GetNumber("Front Ultrasonic P Term:"),
		      SmartDashboard::GetNumber("Front Ultrasonic I Term:"), 
		      SmartDashboard::GetNumber("Front Ultrasonic D Term:"),
		      Robot::drivetrain, Robot::drivetrain);
}
// Called just before this Command runs the first time
void ChassisDrivetoWall::Initialize() 
{
	Robot::drivetrain->HolonomicDrive(DRIVING_POWER, DRIVING_DIRECTION, DRIVING_ROTATION); // Starts motors
}
