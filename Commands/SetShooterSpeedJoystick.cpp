...
void SetShooterSpeedJoystick::Execute()
{
	...
	// convert from Joystick -1..1 to RPM 0..5000
	shooterSpeed = (shooterSpeed + 1) * 2500; 
	
	// set the shooter wheel PID speed
	Robot::shooterWheel->getPIDController()->SetSetpoint(1.0 / (shooterSpeed / 60.0));
