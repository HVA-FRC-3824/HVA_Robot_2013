...
void SetShooterSpeed::Initialize() 
{
	...
	{
		Robot::shooterWheel->getPIDController()->SetSetpoint(shooterSpeed); //RPM to Period in s:
	}
	else
	{
	...
	//printf(" %d\n", Robot::shooterWheel->getPIDController()->IsEnabled());
	Robot::shooterWheel->getPIDController()->Enable();
	//printf("error %f\n", Robot::shooterWheel->getPIDController()->GetError());
}
