...
CANJaguar* RobotMap::pickupMotor = NULL;
DoubleSolenoid* RobotMap::pickupDoubleSolenoid1 = NULL;
...
void RobotMap::init() 
{
	...
	pickupMotor = new CANJaguar(2);
	
	
	pickupDoubleSolenoid1 = new DoubleSolenoid(1, 3, 4);      
