...
SpeedController* RobotMap::shooterWheelMotorFront = NULL;
GearTooth* RobotMap::shooterWheelEncoder = NULL;
SpeedController* RobotMap::shooterWheelMotorBack = NULL;
...
Servo* RobotMap::networkTableTestServotestServo = NULL;
...
void RobotMap::init() 
{
	...
	shooterWheelMotorFront = new Talon(1, 5);
	lw->AddActuator("Shooter Wheel", "Motor Front", (Talon*) shooterWheelMotorFront);
	
	shooterWheelEncoder = new GearTooth(1, 1, false);
	lw->AddSensor("Shooter Wheel", "Encoder", shooterWheelEncoder);
	
	shooterWheelMotorBack = new Talon(1, 10);
	lw->AddActuator("Shooter Wheel", "Motor Back", (Talon*) shooterWheelMotorBack);
	...
	networkTableTestServotestServo = new Servo(1, 7);
	lw->AddActuator("NetworkTableTestServo", "testServo", networkTableTestServotestServo);
