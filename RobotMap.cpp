...
Relay* RobotMap::pickupPickupMotor = NULL;
...
void RobotMap::init() {
	...
	shooterAngleAdjustVictor = new Victor(2, 1);
	...
	pickupPickupMotor = new Relay(1, 3);
	lw->AddActuator("Pickup", "Pickup Motor", pickupPickupMotor);
