...
Pump* Robot::pump = 0;
NetworkTableTestServo* Robot::networkTableTestServo = 0;
OI* Robot::oi = 0;
...
void Robot::RobotInit()
{
   ...
   // PID values for the drive to wall
   SmartDashboard::PutNumber("Front Ultrasonic P Term:", 0.01);
   SmartDashboard::PutNumber("Front Ultrasonic I Term:", 0.001);
   SmartDashboard::PutNumber("Front Ultrasonic D Term:", 0.0);
   ...
   // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
	...
	climber = new Climber();
	pump = new Pump();
	networkTableTestServo = new NetworkTableTestServo();
...
void Robot::TeleopPeriodic()
{
   if (autonomousCommand != NULL)
      Scheduler::GetInstance()->Run();
   Robot::networkTableTestServo->Set(SmartDashboard::GetNumber("servo"));
}
