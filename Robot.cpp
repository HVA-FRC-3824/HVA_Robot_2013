...
//   SmartDashboard::PutNumber("Chassis Turn Angle Degrees", 10);
   ...
   SmartDashboard::PutNumber("Frisbee Size", 320);
   SmartDashboard::PutNumber("Frisbee Offset", 0);
   SmartDashboard::PutNumber("Drive to Size", 0);
...
//   SmartDashboard::PutNumber("Pickup D Term", 0.009); 
   ...
   chooser->AddObject("1) Do Nothing", new AutonomousDoNothing());
   chooser->AddObject("2) Shoot from Side to Top Goal", new AutonomousRPMShootMiddleGoalHard());
   chooser->AddDefault("3) Shoot from Center and then Pickup", new AutonomousRPMShootingwithPickup());
   chooser->AddObject("4) Pickup First and Shoot from Center", new AutonomousRPMShootingwithPickupFirst());
   chooser->AddObject("4) Shoot and Pickup using Camers from Center", new AutonomousRPMShootwithCameraPickup());
