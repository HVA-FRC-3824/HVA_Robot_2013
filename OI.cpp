...
OI::OI()
{
   ...
   // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
	...
	SmartDashboard::PutData("Autonomous RPM Shoot from Center", new AutonomousRPMShootfromCenter());
	SmartDashboard::PutData("Autonomous Shoot Middle Goal Soft", new AutonomousShootMiddleGoalSoft());
	SmartDashboard::PutData("Autonomous RPM Shoot Middle Goal Soft", new AutonomousRPMShootMiddleGoalSoft());
	SmartDashboard::PutData("Autonomous Shoot Middle Goal Hard", new AutonomousShootMiddleGoalHard());
	SmartDashboard::PutData("Autonomous RPM Shoot Middle Goal Hard", new AutonomousRPMShootMiddleGoalHard());
	SmartDashboard::PutData("Autonomous Shoot from Right", new AutonomousShootfromRight());
	SmartDashboard::PutData("Autonomous RPM Shoot from Right", new AutonomousRPMShootfromRight());
	SmartDashboard::PutData("Autonomous Shoot from Left", new AutonomousShootfromLeft());
	SmartDashboard::PutData("Autonomous RPM Shoot from Left", new AutonomousRPMShootfromLeft());
	SmartDashboard::PutData("Autonomous Shoot Middle Goal Hard to Centerline", new AutonomousShootMiddleGoalHardtoCenterline());
	SmartDashboard::PutData("Autonomous RPM Shoot Middle Goal Hard to Centerline", new AutonomousRPMShootMiddleGoalHardtoCenterline());
	SmartDashboard::PutData("Autonomous Drive Forward Shoot", new AutonomousDriveForwardShoot());
	SmartDashboard::PutData("Autonomous RPM Drive Forward Shoot", new AutonomousRPMDriveForwardShoot());
	SmartDashboard::PutData("Frisbee Shoot", new FrisbeeShoot());
	SmartDashboard::PutData("Frisbee Shoot Reversed", new FrisbeeShootReversed());
