...
#include "Commands/HookDowntoEngageTop.h"
...
OI::OI() 
{
   ...
   // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
	...
	SmartDashboard::PutData("Hook Down to Engage Top", new HookDowntoEngageTop());
	SmartDashboard::PutData("Hook Down to Limit", new HookDowntoLimit());
	SmartDashboard::PutData("Hook Engage", new HookEngage());
	SmartDashboard::PutData("Hook Up", new HookUp());
	SmartDashboard::PutData("Climb", new Climb());
	SmartDashboard::PutData("Hook Up to Engage", new HookUptoEngage());
	SmartDashboard::PutData("Test SmartDashboard", new TestSmartDashboard());
