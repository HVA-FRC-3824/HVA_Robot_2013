...
#include "Commands/UpdatePIDTerms.h"
...
OI::OI()
{
   ...
   // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
	...
	SmartDashboard::PutData("UpdatePIDTerms", new UpdatePIDTerms());
   ...
   m_shooterPosition_5 = new DigitalIOButton(INPUT_SHOOTER_POSITION_5);
	...
	m_shooterPosition_1->WhenPressed(new CypressGotoPosition(POSITION_1_ANGLE, POSITION_1_VELOCITY, POSITION_1_VOLTAGE, POSITION_1_IS_RPM));	
	m_shooterPosition_2->WhenPressed(new CypressGotoPosition(POSITION_2_ANGLE, POSITION_2_VELOCITY, POSITION_2_VOLTAGE, POSITION_2_IS_RPM));		
	m_shooterPosition_3->WhenPressed(new CypressGotoPosition(POSITION_3_ANGLE, POSITION_3_VELOCITY, POSITION_3_VOLTAGE, POSITION_3_IS_RPM));	
   m_shooterPosition_4->WhenPressed(new CypressGotoPosition(POSITION_4_ANGLE, POSITION_4_VELOCITY, POSITION_4_VOLTAGE, POSITION_4_IS_RPM));
   m_shooterPosition_5->WhenPressed(new CypressGotoPosition(POSITION_5_ANGLE, POSITION_5_VELOCITY, POSITION_5_VOLTAGE, POSITION_5_IS_RPM));
